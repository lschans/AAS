...
module.exports = function(server) {
    ...
    return {
        server : function(callback) {
            https = https.createServer(options, function (request, response) {
            ...
            if (config.global.verbose === true) console.log('HTTPS-Server started on port ' + config.global.httpsPort);

            // Some socket test stuff
            var socketServer = socketio.listen(https);
            socketServer.adapter(server.redis({ host: 'localhost', port: 6379 }));
