...
module.exports = function(server) {
    ...
    return {
        writeLog : function(msgObj, request) {
            //if(typeof(msgObj.domain == 'undefined')) msgObj.domain = 'general';
            ...
            var msgStr = config.log.format ||  "@@_DATETIME_@@ @@_RESPONSECODE_@@ @@_PID_@@ @@_IP_@@ @@_URL_@@ @@_MESSAGE_@@";
            ...
            // Clear what we couldn't replace and add newline
