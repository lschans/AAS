...
module.exports = function(server, cluster, net) {
    ...
    return {
        execute : function () {
            ...
            services.files.splice(services.files.indexOf('redis-server.js'), 1);
            services.service = {};

            // Start all services
            services.files.forEach(function (value) {
                services.service[value] = spawn('node', ['./redis-server.js', config.services.servicePath + '/' + value + '/index.js']);
