    ...
    var serve = {
        serveFile : function(request, response, callback) {
            ...
            */
            ...
            if(typeof(config.global.app[request.headers.host]) !== 'undefined') {
                ...
                var configDomain = config.global.app.default;
            }
            ...
            if(fs.existsSync(path + cleanUrl)) {
                ...
                console.log('lol 3 -- ' + cleanUrl + ' --  ' + config.global.app[configDomain].roots.common + '/error.html');
        ...
        write : function (request, response) {
            ...
            response.prepareCookies(request, response, function(){
                ...
                console.log('filename: ' + response.fileName + ' extention: ' + response.extention + ' status: ' + response.status);
                ...
                if((response.extention == 'html' || response.extention == 'css' || response.extention == 'js') && response.status === 200) {
                    ...
                    console.log('Oww shit replace errors now:' + config.statusCodes[response.status].message);
                    stream.
