...
module.exports = function(server) {
    ...
    return {
        requestInfo : function(request, response, callback) {
            ...
            response.setSessionData(request, response, {key:"testValue", data:"My server info data test"});
            response.setSessionData(request, response, {key:"testObject", data:{test:"My server info object data test",1:'a','a':1}});
            response.setSessionData(request, response, {key:"testArray", data:["My server info array data test",1,2,3]});
