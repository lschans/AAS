    ...
    return {
        requestInfo : function(request, response, callback) {
            ...
            if(typeof(request.session.data.testObject) == 'undefined')
                response.setSessionData(request, response, {key:"testObject", value:{test:"My server info object data test",1:'a','a':1}});

            if(typeof(request.session.data.testArray) == 'undefined')
                response.setSessionData(request, response, {key:"testArray", value:["My server info array data test",1,2,3]});
