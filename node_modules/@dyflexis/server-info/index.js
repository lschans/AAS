...
module.exports = function(server) {
    ...
    return {
        requestInfo : function(request, response, callback) {
            ...
            response.setSessionData(request, response, {key:"testValue", data:"My data test"});
            //response.setSessionData(request, response, {key:"testObject", data:{test:"My data test"}});

            response.body += '<head><title>' + config.network[0].address + ' - ' + request.headers.host + request.url + '</title></head>';
