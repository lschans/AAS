...
//                worker.serverInfo.addConfig,
            ...
            process.on('message', function(msg, socket) {
                if (msg !== 'http-sticky-session:connection') {
                    if(config.global.verbose === true) console.log('NOT: ' + process.pid);
                    return;
                } else {
                    if(config.global.verbose === true) console.log('send ' + ++x + '  -> ' + socket.remoteAddress);
            ...
            // Worker process messages
            process.on('message', function(msg, socket) {
                if (msg !== 'https-sticky-session:connection') {
                    return;
                } else {
