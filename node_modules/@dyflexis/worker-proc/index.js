...
module.exports = function(server, cluster) {
    ...
    worker.session = require('@dyflexis/session')(server);
    worker.authenticate = require('@dyflexis/authenticate')(server);
        ...
        execute : function () {
            ...
            var respond = function (request, response) {
                ...
                if(typeof(sequences[request.headers.host]) !== 'undefined') {
                    ...
                    if(typeof(sequences[config.global.app.default][request.method.toUpperCase()]) !== 'undefined') {
                        var seqArr = sequences[config.global.app.default][request.method.toUpperCase()].slice(0);
                    } else {
                        var seqArr = sequences[config.global.app.default]['UNDEFINED'].slice(0);
                    }
                }
                ...
                for (var m in app.modules) {
                    if (app.modules.hasOwnProperty(m)) {
                        ...
                        app.modules[m].map(function (module) {
                            ...
                            if (typeof(worker[moduleArr[1]][moduleArr[2]]) === "function") {
                                sequences[app.domain][m].push(worker[moduleArr[1]][moduleArr[2]]);
                            }
                        });
                    }
                }
