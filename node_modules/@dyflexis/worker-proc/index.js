...
module.exports = function(server, cluster) {
    ...
    if (config.global.useSPDY == true) {
        worker.https = require('@dyflexis/spdy-server')(server);
    } else {
        worker.https = require('@dyflexis/https-server')(server);
    }
    ...
    return {
        execute : function () {
            ...
            var write = function (request, response) {
                worker.headers.addResponseHeader(request, response, ['Content-Type', 'text/html']);
