...
module.exports = function(server, cluster) {
    ...
    worker.applicationSelector = require('@dyflexis/application-selector')(server);
    ...
    return {
        execute : function () {
            ...
            var respond = function (request, response) {
                ...
                // Select the application selector based on domain.
                seqArr.unshift(worker.applicationSelector);
